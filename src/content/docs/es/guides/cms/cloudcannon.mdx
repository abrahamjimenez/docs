...
También puede configurar el acceso basado en roles a un [Source Editor](https://cloudcannon.com/documentation/articles/the-source-editor/) mínimo, un editor de código integrado en el navegador para realizar cambios menores en el código fuente de sus archivos.
