...
El panel de tu sitio en CloudCannon te permite organizar las páginas y el contenido de tu proyecto de Astro en colecciones: grupos de archivos relacionados con un formato similar. Esto te permite ver juntos tipos de contenido similares para facilitar la edición y hace que tus archivos de contenido sean fáciles de navegar, ordenar y filtrar.
